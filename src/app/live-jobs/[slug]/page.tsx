...
export default function LiveJobDetailPage() {
  ...
  /**
   * Existing Illuminex application route.
   *
   * This remains available as a safe fallback for any vacancy that does not
   * have a valid Firefish advert reference.
   */
  ...
  /**
   * All valid FF vacancies use their exact native Firefish application page.
   * This creates the native Advert Application, Awaiting Processing record,
   * screening results, CV attachment and Firefish notification emails.
   */
  ...
  const applyHref =
    firefishDirectApplyUrl ?? illuminexApplyHref;
