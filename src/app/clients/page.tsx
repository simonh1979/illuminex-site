      ...
      <section className="page-hero">
        <div className="page-hero-inner">
          ...
          <p style={{ marginTop: 16, maxWidth: 980, fontSize: "clamp(1.05rem, 1.1vw, 1.2rem)", lineHeight: 1.75, opacity: 0.92 }}>
            From Sales Director and Commercial leadership to MD/CEO/CFO appointments, we run search with pace and discipline.
          ...
          <div style={{ marginTop: 34, display: "grid", gridTemplateColumns: "repeat(12, 1fr)", gap: 18 }}>
            <div className="sector-card" style={{ gridColumn: "span 4" }}>
              ...
              <p>
                For senior, confidential or business-critical roles. Structured mapping, targeted approach, and rigorous assessment.
              </p>
            ...
            <div className="sector-card sector-card--cta" style={{ gridColumn: "span 12" }}>
              ...
              <p>
                If you’re hiring across building materials, construction, technical sales, bathrooms, kitchens, education or healthcare,
                we’ll advise on market conditions, competition and realistic timelines — before you commit.
              </p>
              <Link className="sector-cta" href="/contact">Start a confidential brief</Link>
            </div>
          </div>
        </div>
      </section>
